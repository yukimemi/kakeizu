...
export function TreeImportDialog({ destTree, trees, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-ink/30 p-4 backdrop-blur-sm animate-fade-in">
      <div className="flex max-h-[90vh] max-h-[90dvh] w-full max-w-xl animate-fade-in-up flex-col overflow-hidden rounded-xl border border-ink-line bg-paper shadow-paper-lg">
