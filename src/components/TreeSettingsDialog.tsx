...
export function TreeSettingsDialog({ tree, uid, myEmail, onClose }: Props) {
  ...
  return (
    <div className="absolute inset-0 z-40 flex items-stretch justify-stretch bg-ink/30 backdrop-blur-sm animate-fade-in sm:items-center sm:justify-center sm:p-4">
      <div className="flex h-full w-full animate-fade-in-up flex-col overflow-hidden border border-ink-line bg-paper sm:h-auto sm:max-h-full sm:max-w-lg sm:rounded-xl sm:shadow-paper-lg">
