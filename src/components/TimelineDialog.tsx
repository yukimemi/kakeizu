...
export function TimelineDialog({ persons, onPick, onClose }: Props) {
  ...
  return (
    <div
      className="absolute inset-0 z-40 flex items-start justify-center bg-ink/30 p-4 pt-16 backdrop-blur-sm animate-fade-in"
      onClick={onClose}
    >
      <div
        className="flex max-h-full w-full max-w-2xl animate-fade-in-up flex-col overflow-hidden rounded-xl border border-ink-line bg-paper shadow-paper-lg"
